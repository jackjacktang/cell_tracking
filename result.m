...
% Last Modified by GUIDE v2.5 28-Mar-2017 16:00:22
...
[f,p]=uiputfile({'*.png'},'Save file name');
str=strcat(p,f);
brbr=get(currentHandles.result,'children');
figure('visible','off');
axes;
copyobj(brbr,gca);
print(gcf,'-zbuffer','-dpng','-r1000',str);

% --- Executes on button press in closeResult.
function closeResult_Callback(hObject, eventdata, handles)
close;